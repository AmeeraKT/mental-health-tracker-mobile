        ...
        onTap: () async {
          ...
          ScaffoldMessenger.of(context)
            ...
            if (item.name == "Add Mood") {
              // Used Navigator.push to navigate to a MaterialPageRoute that includes TrackerFormPage.
              Navigator.push(
                context,
                MaterialPageRoute(
            ...
            // add the else if statement below
                ...
                final response = await request.logout(
                    // Changed the URL to your Django app's URL. Don't forget to add the trailing slash (/) if needed.
